...
notification-kick-self = Sunucu kendisini oyundan atamaz.
notification-kick-none = O slotta kimse yok.
notification-no-kick-game-started = Oyun başladıktan sonra sadece izleyicilier ve kaybetmiş oyuncular atılabilir.
