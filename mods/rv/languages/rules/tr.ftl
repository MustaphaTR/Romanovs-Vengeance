...
actor-cadmfgl =
   .name = Bayrak
actor-causfgl =
   .name = Amerikan Bayrağı
actor-caukfgl =
   .name = Britanya Bayrağı
actor-cafrfgl =
   .name = Fransız Bayrağı
actor-cagefgl =
   .name = Alman Bayrağı
actor-caskfgl =
   .name = Kore Bayrağı
...
actor-cairfgl =
   .name = Irak Bayrağı
actor-cavnfgl =
   .name = Vietnam Bayrağı
actor-cacufgl =
   .name = Küba Bayrağı
actor-calbfgl =
   .name = Libya Bayrağı
actor-capcfgl =
   .name = Yurigrad Bayrağı
actor-caplfgl =
   .name = Lazarus Corps Flag
actor-capsfgl =
   .name = Antarktik Bayrağı
actor-captfgl =
   .name = Transylvanya Bayrağı
actor-capmfgl =
   .name = Lunar Eclipse Flag
actor-catcfgl =
   .name = Transkafkas Bayrağı
actor-catmfgl =
   .name = Türkmen Bayrağı
actor-catvfgl =
   .name = Tuva Bayrağı
actor-carffgl =
   .name = Rus Bayrağı
actor-casmfgl =
   .name = Sırbistan-Karadağ Bayrağı
actor-cajpfgl =
   .name = Japon Bayrağı
actor-cablfgl =
   .name = Belarus Bayrağı
actor-capofgl =
   .name = Leh Bayrağı
actor-cauafgl =
   .name = Ukrayna Bayrağı
actor-cachfgl =
   .name = Çin Bayrağı
actor-caaufgl =
   .name = Avustralya Bayrağı
actor-catrfgl =
   .name = Türk Bayrağı
actor-cacnfgl =
   .name = Kanada Bayrağı
actor-caclfgl =
   .name = Şili Bayrağı
actor-camxfgl =
   .name = Meksika Bayrağı
actor-camofgl =
   .name = Moğol Bayrağı
actor-caarfgl =
   .name = Ermeni SSC Bayrağı
actor-caazfgl =
   .name = Azerbaycan SSC Bayrağı
actor-cagofgl =
   .name = Gürcü SSC Bayrağı
actor-cakzfgl =
   .name = Kazak SSC Bayrağı
actor-cakyfgl =
   .name = Kırgız SSC Bayrağı
actor-carsfgl =
   .name = Rus SFSC Bayrağı
actor-catjfgl =
   .name = Tacik SSC Bayrağı
actor-cauzfgl =
   .name = Özbek SSC Bayrağı
actor-caatfgl =
   .name = Avusturya Flag
actor-cabefgl =
   .name = Belçika Bayrağı
actor-cabrfgl =
   .name = Brezilya Bayrağı
actor-cacyfgl =
   .name = Kıbrıs Bayrağı
actor-caczfgl =
   .name = Çekoslovak Bayrağı
actor-cadnfgl =
   .name = Danimarka Bayrağı
actor-canlfgl =
   .name = Felemenk Bayrağı
actor-caesfgl =
   .name = Eston Bayrağı
actor-caphfgl =
   .name = Filipin Bayrağı
actor-cafifgl =
   .name = Fin Bayrağı
actor-cagrfgl =
   .name = Yunan Bayrağı
actor-cahufgl =
   .name = Macar Bayrağı
actor-cainfgl =
   .name = Endonez Bayrağı
actor-caeifgl =
   .name = İrlanda Bayrağı
actor-caitfgl =
   .name = İtalyan Bayrağı
actor-calafgl =
   .name = Leton Bayrağı
actor-calefgl =
   .name = Lübnan Bayrağı
actor-califgl =
   .name = Litvan Bayrağı
actor-calxfgl =
   .name = Lüksemburg Bayrağı
actor-camlfgl =
   .name = Malta Bayrağı
actor-camrfgl =
   .name = Fas Bayrağı
actor-canzfgl =
   .name = Yeni Zelanda Bayrağı
actor-canwfgl =
   .name = Norveç Bayrağı
actor-caomfgl =
   .name = Umman Bayrağı
actor-caslfgl =
   .name = Sloven Bayrağı
actor-caspfgl =
   .name = İspanyol Bayrağı
actor-cazafgl =
   .name = Zaire Bayrağı
actor-caalfgl =
   .name = Arnavut Bayrağı
actor-cabmfgl =
   .name = Burma Bayrağı
actor-cacgfgl =
   .name = Kongo Bayrağı
actor-cakmfgl =
   .name = Kampuçya Bayrağı
actor-calofgl =
   .name = Laos Bayrağı
actor-cancfgl =
   .name = Nicaragua Bayrağı
actor-caprfgl =
   .name = Peru Bayrağı
actor-casofgl =
   .name = Somali Bayrağı
...
actor-cabufgl =
   .name = Bulgar Bayrağı
actor-cabunfgl =
   .name = Bulgar Deniz Sancağı
actor-caicfgl =
   .name = İzlanda Bayrağı
actor-cajrfgl =
   .name = Ürdün Bayrağı
actor-cangfgl =
   .name = Nijerya Bayrağı
actor-capnfgl =
   .name = Panama Bayrağı
actor-capgfgl =
   .name = Portekiz Bayrağı
actor-caswfgl =
   .name = İsveç Bayrağı
actor-caszfgl =
   .name = İsviçre Bayrağı
actor-cahlfgl2 =
   .name = Angriver Bayrağı
actor-caeqfgl =
   .name = Ekvestriya Bayrağı
actor-cahlfgl =
   .name = Herzland Bayrağı
actor-capvfgl =
   .name = Ponyville Bayrağı
...
actor-ssrv =
   .name = Secret Service
actor-pres =
   .name = Başkan Michael Dugan
actor-rmnv =
   .name = Başbakan Alexander Romanov
actor-eins =
   .name = Profesör Albert Einstein
actor-mumy =
   .name = Mumya
actor-myak =
   .name = Chairman Mustapha Yakubov
actor-rainbow =
   -dash.name = Rainbow Dash
actor-derpy =
   -hooves.name = Derpy Hooves
actor-yuripr =
   -regicide.name = Master Yuri
