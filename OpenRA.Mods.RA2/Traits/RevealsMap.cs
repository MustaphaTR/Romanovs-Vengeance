...
namespace OpenRA.Mods.Common.Traits
{
	public class RevealsMapInfo : ConditionalTraitInfo
    {
		...
		public override object Create(ActorInitializer init) { return new RevealsMap(init.Self, this); }
	}

	public class RevealsMap : ConditionalTrait<RevealsMapInfo>, INotifyKilled, INotifyActorDisposing
    {
        readonly RevealsMapInfo info;
        readonly Shroud.SourceType type;

        public RevealsMap(Actor self, RevealsMapInfo info)
            : base(info)
        {
            this.info = info;
